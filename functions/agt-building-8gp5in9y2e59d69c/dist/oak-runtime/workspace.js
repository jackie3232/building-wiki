...
let cachedOakWorkspaceCwd;
/** Ensures writable session cwd exists; cached for process lifetime. */
export function resolveOakWorkspaceCwd() {
    if (cachedOakWorkspaceCwd)
        return cachedOakWorkspaceCwd;
    ...
    try {
        ...
        console.warn(`[OAK] Workspace cwd not writable (${dir}): ${err.message}`);
    }
